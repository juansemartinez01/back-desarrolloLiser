// src/modules/backoffice/cc/estado/bo-estado-cuenta.service.ts
...
@Injectable()
export class BoEstadoCuentaService {
  constructor(private readonly ds: DataSource) {}

  async estadoCuenta(q: BoQueryEstadoCuentaDto) {
    const includeMovs =
    ...
    return {
      ...
      cuenta, // <- si querés, también lo saco del response; decime y lo dejamos sin este campo
